...
import { TestimonialsCardDemo, TestimonialsAutoPlayDemo, TestimonialsNoNavDemo, TestimonialsWidthDemo } from '@/components/docs/testimonials-card'
...
<ComponentPreview
  component={<TestimonialsAutoPlayDemo />}
...
<ComponentPreview
  component={<TestimonialsNoNavDemo />}
  code={`<TestimonialsCard 
  items={testimonials} 
...
<ComponentPreview
  component={<TestimonialsWidthDemo />}
  code={`<TestimonialsCard 
  items={testimonials} 
  width={500}
/>`}
